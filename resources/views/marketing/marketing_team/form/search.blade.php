<div class="row">
    ...
    <div class="col-lg-12 col-sm-12 col-md-3">
        <div class="row">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <input type="text" class="form-control" name="search"
                                placeholder="Code, No, Ward, House Style, Price, Name, Phone, Email, Address, Remark"
                                value="{{ old('search') }}">
                        </div>
                    </div>
                </form>
            ...
            <div class="col-lg-3 form-group">
                <input type="text" class="form-control" placeholder="Price Min">
            </div>

            <div class="col-lg-3 form-group">
                <input type="text" class="form-control" placeholder="Price Max">
            </div>
            ...
            <div class="col-lg-3 form-group">
                <select class="form-control form-control-lg" data-plugin="select2" name="township_id">
                    <option value="">
                        All
                    </option>
            ...
            <div class="col-lg-3 form-group">
                <input list="WardList" class="form-control @error('ward') is-invalid @enderror" type="text"
                    name="ward" value="{{ old('ward') }}" id="WardNo" oninput="getAlreadyMarketingProperty()" />
            ...
            {{-- Property Type --}}
            <div class="col-lg-3 form-group">
                <select class="form-control" name="property_type_id" data-plugin="select2">
    ...
    <div class="col-lg-4 col-sm-12 col-md-3" hidden>
        <form action="{{ route('marketing_team.index') }}" method="GET" autocomplete="off">
            <div class="form-group">
                <div class="form-group">
                    <div class="input-group mb-3">
                        <input id="datetimepicker4" class="form-control @error('from_date') is-invalid @enderror"
                            type="text" name="from_date" value="{{ old('from_date') }}" />
