                    ...
                    <div class="row row-lg">
                        <div class="col-md-12 col-lg-12">
                            <div class="example-wrap">
                                <div class="example">
                                    <form action="{{ route('want_to_buy.update', $want_to_buy->id) }}" method="POST"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text"
                                                    ...
                                                    name="customer_name" value="{{ $want_to_buy->customer_name ?? '' }}">
                                                @error('customer_name')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text"
                                                    ...
                                                    name="phone_number" value="{{ $want_to_buy->phone_number ?? '' }}">
                                                @error('phone_number')
                                                    <div class="invalid-feedback"> {{ $message }} </div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text"
                                                    ...
                                                    name="address" value="{{ $want_to_buy->address ?? '' }}">
                                                @error('address')
                                                    <div class="invalid-feedback"> {{ $message }} </div>
                                                @enderror
                                            </div>
                                                        ...
                                                        <optgroup label="{{ $region->region ?? '' }}">
                                                            @foreach ($region->townships_table as $township)
                                                                <option value="{{ $township->id ?? '' }}"
                                                                    @if ($township->id == $want_to_buy->township_id) selected @endif>
                                                                    - {{ $township->township ?? '' }}
                                                                </option>
                                                            @endforeach
                                                        </optgroup>
                                                ...
                                                <select class="form-control" data-plugin="select2" name="property_type_id">
                                                    ...
                                                    @foreach ($property_types as $property_type)
                                                        <option value="{{ $property_type->id }}"
                                                            @if ($property_type->id == $want_to_buy->property_type_id) selected @endif>
                                                ...
                                                <div class="input-daterange">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="price_to" value="{{ $want_to_buy->price_to ?? '' }}" />
                                                        @error('price_to')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text"
                                                    ...
                                                    name="remark" value="{{ $want_to_buy->remark ?? '' }}">
                                                @error('remark')
                                                    <div class="invalid-feedback"> {{ $message }} </div>
                                                @enderror
                                            </div>
                                                            ...
                                                            <div class="input-group">
                                                                <div class="col-md-12">
                                                                    <select class="form-control" name="area_type"
                                                                        style="width: 100%">
                                                                        <option value="Sqft"
                                                                            @if ('Sqft' == $want_to_buy->area_type) selected @endif>
                                                                            Sqft
                                                                        </option>
                                                                        <option value="Acre"
                                                                            @if ('Acre' == $want_to_buy->area_type) selected @endif>
                                                                            Acre
                                                                        </option>
                                                                    </select>
                                                                    @error('area_type')
                                                        ...
                                                        <div class="input-daterange">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $want_to_buy->area_width * $want_to_buy->area_height }}" />
                                                                <span class="input-group-addon">
                                                                    Sqft
                                                                </span>
                                                            </div>
