                                                    ...
                                                    <td style="text-align: center">
                                                        @if ($value->photo)
                                                            <img src="{{ Storage::url($value->photo) }}" alt=""
                                                                style="width: 50px; height: 50px; background-position: top; background-size: contain; object-fit: cover;">
                                                        @endif
                                                    </td>
                                                    <td style="text-align: center;">
                                                        {{ $value->name }}
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('lawyer.edit', $value->id) }}"
                                                                    role="menuitem">
                                                                    <i class="icon md-edit" aria-hidden="true"></i>
                                                                    Edit
                                                                </a>

                                                                <form action="{{ route('lawyer.destroy', $value->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
